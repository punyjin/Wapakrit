     ...
     <div class="modal-content">
         ...
         <div class="modal-body">
                         ...
                         <div class="form-group">
                             <input type="text" class="form-control form-control-user" id="user_check" placeholder="กรุณากรอกชื่อผู้ใช้หรือเบอโทรศัพท์" name="user_check" value="<?php $dbarr['staff_id']?>" readonly="">
 ...
 <div class="modal-dialog" role="document">
     <div class="modal-content">
         ...
         <div class="modal-body">
                         ...
                         <div class="form-group">
                             <input type="text" class="form-control" id="user_check" placeholder="กรุณากรอกชื่อผู้ใช้หรือเบอโทรศัพท์" name="user_check" value="<?php $dbarr['staff_id']?>" readonly="">
                         ...
                         <div class="form-group">
                                     <select name="classroom" class="form-control chosen-select" style="display: none;">
                                                     <option value="0"> Select Name </option>
                                                                                 </select><div class="chosen-container chosen-container-single" style="width: 0px;" title=""><a class="chosen-single" tabindex="-1"><span>เลือกห้องเรียน</span><div><b></b></div></a><div class="chosen-drop"><div class="chosen-search"><input type="text" autocomplete="off"></div><ul class="chosen-results"></ul></div></div>
                         </div>
                         <div class="form-group">
